        ...
        <>
            <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 4 }}>
                ...
                <Grid item xs={12} sx={{ marginLeft: "2rem", marginTop: "1rem" }}>
                    ...
                    <Typography component="p" sx={{ width: "90%", ml: "0.5rem", color: "#0F3E86", overflowWrap: 'break-word' }} >
                ...
                <Grid item xs={12} sx={{ marginLeft: "2rem", marginTop: "1rem" }}>
                    ...
                    <Typography component="p" sx={{ width: "90%", color: "#0F3E86", overflowWrap: 'break-word' }} >
